...
export default function SiteShell({ children }) {
  return <>
    <header className="site-nav">
      <Link className="brand" href="/"><Image src="/assets/images/app-logo.webp" alt="" width={30} height={30} />HisabDo<span>.</span></Link>
    ...
    <footer className="site-footer">
      <div><Link className="brand" href="/"><Image src="/assets/images/app-logo.webp" alt="" width={30} height={30} />HisabDo<span>.</span></Link><p>Offline-first finance tools for the businesses that keep communities moving.</p></div>
