...
export function mobileApplicationSchema() {
  return {
    ...
    operatingSystem: 'Android',
    applicationCategory: 'FinanceApplication',
    installUrl: SITE.playStore,
    offers: { '@type': 'Offer', price: '0', priceCurrency: 'USD' },
    featureList: [
      'Offline-first khata and ledger management',
      'Customer credit and udhar tracking',
      'Expense and income recording',
      'Receivable and payable management',
      'PDF report export',
      'Voice entry support',
      'Multi-language: Urdu, English, Hindi, Arabic',
      'Multi-currency: PKR, USD, INR',
      'Backup and restore',
    ],
