        ...
        <main id="main-content">
            ...
            <section className="section">
                <div className="split fade-up">
                    ...
                    <div className="split-img">
                        <img src="/assets/images/dashboard.webp" alt="HisabDo dashboard" loading="lazy" decoding="async" width="702" height="1600" />
                    </div>
                </div>
            </section>
            ...
            <section className="section">
                <div className="split fade-up">
                    ...
                    <div className="split-img">
                        <img src="/assets/images/ledger.webp" alt="Ledger and backup concept" loading="lazy" decoding="async" width="738" height="1600" />
                    </div>
                </div>
            </section>
            ...
            <section className="section">
                ...
                <div className="section-divider fade-up"></div>
                <div className="grid fade-up">
                    <div className="card"><h3>Founder</h3><p>Learn more about the person behind the project and the product vision.</p><Link className="btn-outline" href="/founder">View Founder Profile</Link></div>
