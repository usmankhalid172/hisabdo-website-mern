    ...
    return (
        <main id="main-content">
            ...
            <section className="hero">
                ...
                <p style={{ color: 'var(--muted)', maxWidth: '560px', margin: '0 auto 28px' }}>Join the HisabDo team and help us build a digital finance app for users and small businesses in Pakistan. We value talent, hustle, and people who want to create real impact.</p>
                <a className="btn" href="https://forms.gle/YhAfaw1CzCF9mEZo9" target="_blank" rel="noopener noreferrer"><i className="fas fa-paper-plane"></i> Register for Internship</a>
            </section>
                ...
                <div style={{ background: 'rgba(34,197,94,.06)', border: '1px solid rgba(34,197,94,.25)', borderRadius: '14px', padding: '24px 28px' }}>
                    <div style={{ display: 'flex', alignItems: 'flex-start', gap: '14px', flexWrap: 'wrap' }}>
                        <div style={{ flex: 1, minWidth: '240px' }}>
                            <div style={{ fontSize: '15px', fontWeight: 700, color: '#e2e8f0', marginBottom: '8px' }}>🚀 Applications Open — 60-Day Remote Internship Bootcamp</div>
                            <p style={{ color: 'var(--muted)', fontSize: '14px', marginBottom: '12px' }}>Applications are now open for our <strong style={{ color: '#e2e8f0' }}>60-Day Remote Internship Bootcamp (August–September 2026)</strong> for Undergraduate Students and Recent Graduates.</p>
                            ...
                            <div style={{ background: 'rgba(234,179,8,.06)', border: '1px solid rgba(234,179,8,.2)', borderRadius: '8px', padding: '10px 14px', color: '#fbbf24', fontSize: '13px' }}>⚠️ Limited Seats — Register as soon as possible to secure your spot.</div>
                        </div>
                    </div>
                    <div style={{ textAlign: 'center', marginTop: '20px' }}>
                        <a className="btn" href="https://forms.gle/YhAfaw1CzCF9mEZo9" target="_blank" rel="noopener noreferrer"><i className="fas fa-paper-plane"></i> Register Now</a>
                    </div>
                </div>
            </div>
            ...
            <section className="section">
                ...
                <div className="card fade-up" style={{ maxWidth: '860px', margin: '0 auto', padding: '28px 26px' }}>
                    ...
                    <div style={{ textAlign: 'center', marginTop: '24px' }}><a className="btn" href="https://forms.gle/YhAfaw1CzCF9mEZo9" target="_blank" rel="noopener noreferrer"><i className="fas fa-paper-plane"></i> Apply Now</a></div>
                </div>
            </section>
